...
/// @title PokeMon
/// @notice This smart contract is used to create a battle card game
/// @notice Version 1.0.0
/// @author MintBlinders
/// @author Ankit suthar
/// @author Dhruvit Salat
/// @author Thakor Aarya

contract PokeMon is ERC1155, Ownable, ERC1155Supply {
    string public baseURI; // baseURI where token metadata is stored
    uint256 public totalSupply; // Total number of tokens minted
    //   we have to change the name of these to the names of  pokemons
...
// The following function creates a new GameToken and pushes it to the gameTokens array.
